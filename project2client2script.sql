# The client2 user execution script for Project Two - CNT 4714 - Summer 2024
# all commands assumed to be executed by the client2 user
# the client2 user has only selection and update privileges on the project2 and bikdeb database schemas.
...
#Commands 2A, 2B, and 2C - All project2:
...
#Commands 3A, 3B, and 3C - All project2:
