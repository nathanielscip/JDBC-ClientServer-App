# The client user execution script for Project Two - CNT 4714 - Summer 2024
# all commands assumed to be executed by the client1 user
# the client1 user has only selection  privilege on the project2 and bikdeb database schemas.
